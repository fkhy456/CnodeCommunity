    ...
    <div class="UserInfo">
        ...
        <div class="userInfomation">
            <section>
                ...
                <span style="color: #778087;">{{userinfo.loginname}}</span>
                <p>
                    {{userinfo.score}} 积分
                </p>
                <p>
                    github: <a style="text-decoration: none;color: #778087;" :href="'https://github.com/' + userinfo.githubUsername">@{{userinfo.githubUsername}}</a>
                </p>
                <p style="color: #ababab;margin-bottom: 0px;">
